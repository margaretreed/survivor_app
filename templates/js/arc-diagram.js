...
// Read data
d3.json(`/episode-data/${season_num}/${episode_num}`, function( data) {
...
.attr("cy", height-30)
.attr("r", function(d){ return(size(d.n)*3)})
...
labels
  .style("font-size", function(label_d){ return label_d.name === d.name ? 16 : 12 } )
